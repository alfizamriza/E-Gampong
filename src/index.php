...
if (!isset($_SESSION['stat_login_user']) || $_SESSION['stat_login_user'] !== true) {
            ...
            <div class="mt-16 grid divide-x divide-y divide-teal-700
                ...
                <div class="group relative bg-white dark:bg-teal-800
                    ...
                    <div class="relative space-y-8 py-12 p-8">
                        ...
                        <a href="views/surat_tidak_mampu/index.php" class="flex items-center
                                    justify-between
                                    group-hover:text-secondary">
                            <span class="text-sm text-orange-300">Buat</span>
                ...
                <div class="group relative bg-white dark:bg-teal-700
                    ...
                    <div class="relative space-y-8 py-12 p-8">
                        ...
                        <a href="views/surat_pindah/index.php" class="flex items-center justify-between group-hover:text-secondary">
                            <span class="text-sm text-orange-300">Buat</span>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#FFA500" class="w-5 h-5 -translate-x-4 text-2xl
                                        opacity-0 transition duration-300
                                        group-hover:translate-x-0
                ...
                <div class="group relative bg-white dark:bg-teal-700
                    ...
                    <div class="relative space-y-8 py-12 p-8">
                        ...
                        <div class="space-y-2">
                            ...
                            <p class="text-gray-600 dark:text-gray-300">
                                Surat Kematian adalah dokumen resmi yang
                                mencatat fakta kematian seseorang,
                                berisi informasi penting dan digunakan
                                untuk keperluan administratif dan hukum.
                            </p>
                        </div>
                        <a href="#" class="flex items-center
                                    justify-between
                                    group-hover:text-secondary">
                            <span class="text-sm text-orange-300">SOON</span>
                ...
                <div class="group relative bg-gray-50 dark:bg-teal-800
                    ...
                    <div class="relative space-y-8 py-12 p-8 ">
                        ...
                        <div class="space-y-2">
                            ...
                            <p class="text-gray-600 dark:text-gray-300">
                                Fitur untuk melihat status urat anda.
                            </p>
                        </div>
                        <a href="status_user.php" class="flex items-center
                                    justify-between
                                    group-hover:text-secondary">
                            <span class="text-sm text-orange-300">SELENGKAPNYA</span>
                            <svg xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24" fill="#FFA500"
                                    class="w-5 h-5 -translate-x-4 text-2xl
                                    opacity-0 transition duration-300
