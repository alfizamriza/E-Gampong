	...
	<div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style="max-width:1000px">
		<div class="md:flex w-full">
			...
			<div class="w-full md:w-1/2 py-10 px-5 md:px-10">
				...
				<div class="flex -mx-3">
					<div class="w-full px-3 mb-5">
						...
						<div class="flex">
							...
							<input id="NIK" name="NIK" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-teal-900" placeholder="110829*******" required></div>
					</div>
				</div>
				<!-- No.KK -->
				<div class="flex -mx-3">
					<div class="w-full px-3 mb-5">
						<label for="" class="text-xs font-semibold px-1">No. Kartu Keluarga</label>
						<div class="flex">
							<div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
								<i class="mdi mdi-email-outline text-gray-400 text-lg"></i>
							</div>
							<input id="NoKK" type="text" name="No_KK" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-teal-900" placeholder="110829********" required></div>
					</div>
				</div>
				<!-- Nama -->
				<div class="flex -mx-3">
					<div class="w-full px-3 mb-5">
						...
						<div class="flex">
							...
							<input type="text" name="Nama" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-teal-900" placeholder="Montu Sinaga" required></div>
					</div>
				</div>
				<!-- Tempat lahir -->
				<div class="flex -mx-3">
					<div class="w-full px-3 mb-5">
						...
						<div class="flex">
							...
							<input type="text" name="Tempat_Lahir" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-teal-900" placeholder="Banda Aceh" required></div>
					</div>
				</div>
				<!-- Tanggal lahir -->
				<div class="flex -mx-3">
					<div class="w-full px-3 mb-5">
						...
						<div class="flex">
							...
							<input type="date" name="Tanggal_Lahir" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-teal-900" placeholder="Montu Sinaga" required></div>
					</div>
				</div>
				<!-- Alamat -->
				<div class="flex -mx-3">
					<div class="w-full px-3 mb-5">
						...
						<div class="flex">
							...
							<input type="text" name="Alamat" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-teal-900" placeholder="Gampong Paya, Kec Pidie, Kab Pidie, Prov Aceh" required/>
						</div>
					</div>
				</div>
				<!-- No WA -->
				<div class="flex -mx-3">
					<div class="w-full px-3 mb-5">
						<label for="" class="text-xs font-semibold px-1">No. WhatsApp</label>
						<div class="flex">
							<div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
								<i class="mdi mdi-email-outline text-gray-400 text-lg"></i>
							</div>
							<input id="NoWA" type="text" name="No_WA" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-teal-900" placeholder="08*********" required></div>
					</div>
				</div>
				<!-- Jenis Kelamin -->
				<div class="flex -mx-3">
					<div class="w-full px-3 mb-5">
						...
						<div class="flex items-center">
							...
							<select name="JK" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-teal-900">
				...
				<div class="flex -mx-3">
					<div class="w-full px-3 mb-12">
						...
						<div class="flex">
							...
							<input type="password" name="Password" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-teal-900" placeholder="************" required></div>
					</div>
				</div>
				<a href="">
				<div class="flex -mx-3">
					<div class="w-full px-3 mb-5">
                    <button type="submit" class="block w-full max-w-xs mx-auto bg-teal-700 hover:bg-teal-900 text-white rounded-lg px-3 py-3 font-semibold">DAFTAR SEKARANG</button>
					</div>
				</div>
				</a>
                </form>
...
<script>
    ...
    // Menangani input event untuk elemen dengan ID "NoKK"
    document.getElementById("NoKK").addEventListener("input", function(event) {
    // Hapus karakter non-angka dari input
        this.value = this.value.replace(/\D/g, "");
    });
    // Menangani input event untuk elemen dengan ID "NoWA"
    document.getElementById("NoWA").addEventListener("input", function(event) {
    // Hapus karakter non-angka dari input
        this.value = this.value.replace(/\D/g, "");
    });
</script>
