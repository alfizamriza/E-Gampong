        ...
        <div class="container w-full md:w-90/100 xl:w-80/100 mx-auto px-2 z">
            ...
            <div id='recipients' class="p-8 mt-6 lg:mt-0 rounded shadow
                ...
                <table id="example" class="z-auto stripe hover mt-8" style="width:100%;
                    ...
                    <tbody>
                    <?php
                                                    $sql = "SELECT * FROM surat_pindah where status = 0";
                                                    $query = mysqli_query($conn,$sql);
                                                    while($data=mysqli_fetch_array($query,MYSQLI_BOTH)){
                                                        $No_Surat_Pindah=$data['No_Surat_Pindah'];
														$nik = $data['NIK'];
                                                        $nama = $data['Nama'];
                                                        $alamat = $data['Alamat_baru'];
                                                        $tgl_lahir = $data['Tgl_pindah'];
                                                ...
                                                ?>
												<tr>
													<td><?php echo $No_Surat_Pindah;?></td>
                                                    <td><?php echo $nik;?></td>
                                                    <td><?php echo $nama;?></td>
													...
													<td>
														...
														<a href="view_cetak_sp.php?No_Surat_Pindah=<?= $No_Surat_Pindah; ?>">
